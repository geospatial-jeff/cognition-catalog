...
class ConfigLoader(object):
    ...
    def __init__(self):
        self.catalog_config = os.path.join(os.path.dirname(__file__), 'config.yml')
        ...
        self.configs = self.load_configs(['catalog_config', 'api_config', 'cd_config'])
    ...
    def build_configs(self):
        ...
        self.configs['api_config']['default']['system_bucket'] = self.configs['catalog_config']['sat-api']['bucket']
        self.configs['api_config']['default']['lambdas']['ingest']['envs']['SUBNETS'] = ' '.join(self.configs['catalog_config']['sat-api']['subnets'])
        self.configs['api_config']['default']['lambdas']['ingest']['envs']['SECURITY_GROUPS'] = self.configs['catalog_config']['sat-api']['security-group']

        # Update cognition-datsources configuration
        self.configs['cd_config']['custom']['service-name'] = self.configs['catalog_config']['cognition-datasources']['name']
        self.configs['cd_config']['custom']['stage'] = self.configs['catalog_config']['cognition-datasources']['stage']
